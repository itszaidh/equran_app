...
class RollState extends State<Roll> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(Roll oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.crinkle.min != oldWidget.crinkle.min ||
        widget.crinkle.max != oldWidget.crinkle.max ||
        widget.crinkle.period != oldWidget.crinkle.period ||
        widget.crinkle.shouldReverse != oldWidget.crinkle.shouldReverse) {
